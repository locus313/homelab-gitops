...
### Dependencies
- Bump the docker-images group across 10 directories with 12 updates (#433).
- Bump the terraform-providers group across 2 directories with 3 updates (#432).
...
### Dependencies
- Bump the docker-images group across 9 directories with 11 updates (#421).

## [2026-08-21]

### Dependencies
- Bump the docker-images group across 4 directories with 6 updates (#420).

## [2026-08-20]

### Changed
- `workflow` — Update Plex image update schedule to weekly on Fridays.
...
- Bump hashicorp/null (#416).
- Bump alexta69/metube (#418).
...
### Dependencies
- Bump the docker-images group across 2 directories with 2 updates (#412).
...
### Dependencies
- Bump the docker-images group across 3 directories with 3 updates (#410).

## [2026-08-10]

### Dependencies
- Bump the docker-images group across 7 directories with 7 updates (#409).
...
### Dependencies
- Bump the docker-images group across 3 directories with 3 updates (#406).
...
### Dependencies
- Bump the docker-images group across 5 directories with 5 updates (#403).

## [2026-07-28]

### Dependencies
- Bump the docker-images group across 4 directories with 5 updates (#402).
- Bump portainer/portainer (#401).
...
- Bump the docker-images group across 4 directories with 4 updates (#398).

## [2026-07-22]

### Dependencies
- Bump the docker-images group across 2 directories with 2 updates (#397).
...
### Dependencies
- Bump the docker-images group across 4 directories with 4 updates (#393).

## [2026-07-16]

### Dependencies
- Bump the docker-images group across 3 directories with 3 updates (#392).

## [2026-07-14]

### Dependencies
- Bump the docker-images group across 6 directories with 7 updates (#391).

## [2026-07-13]

### Dependencies
- Bump the docker-images group across 4 directories with 4 updates (#390).

## [2026-07-10]

### Dependencies
- Bump the docker-images group across 2 directories with 2 updates (#389).

## [2026-07-09]

### Dependencies
- Bump the docker-images group across 4 directories with 4 updates (#388).

## [2026-07-08]

### Dependencies
- Bump the docker-images group across 2 directories with 2 updates (#387).
...
### Dependencies
- Bump the docker-images group across 3 directories with 3 updates (#382).

## [2026-07-01]

### Dependencies
- Bump the docker-images group across 8 directories with 10 updates (#381).

## [2026-06-30]

### Dependencies
- Bump the docker-images group across 2 directories with 3 updates (#380).

## [2026-06-29]

### Dependencies
- Bump the docker-images group across 4 directories with 5 updates (#379).
- Bump bpg/proxmox (#378).
...
### Dependencies
- Bump the docker-images group across 4 directories with 5 updates (#375).
...
- `docker/traefik` — Set websecure readTimeout to 4h instead of unlimited.
...
### Dependencies
- Bump the docker-images group across 6 directories with 6 updates (#373).
- Bump the terraform-providers group across 2 directories with 2 updates (#372).
...
### Dependencies
- Bump the docker-images group across 3 directories with 3 updates (#369).

## [2026-06-18]

### Dependencies
- Bump the docker-images group across 3 directories with 3 updates (#368).

## [2026-06-17]

### Dependencies
- Bump the docker-images group across 3 directories with 3 updates (#367).

## [2026-06-15]

### Dependencies
- Bump the docker-images group across 5 directories with 5 updates (#366).
...
### Dependencies
- Bump the docker-images group across 2 directories with 2 updates (#365).

## [2026-06-10]

### Dependencies
- Bump the docker-images group across 3 directories with 3 updates (#364).
...
- Add pre-commit hook for YAML linting, Docker image tag detection, and secret scanning.
...
### Dependencies
- Bump the docker-images group across 3 directories with 4 updates (#355).
- Bump the docker-images group across 3 directories with 3 updates (#356).
